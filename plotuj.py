...
A_mu1  = [A_all[i]  for i in indexRange if mu_all[i] > .999]
A0_mu1 = [A0_all[i] for i in indexRange if mu_all[i] > .999]

ax2 = fig.add_subplot(111)
ax2.set_title("Počáteční vs asymptotické A v mua > 0.995")
ax2.set_xlabel("A0")
ax2.set_ylabel("A inf")
